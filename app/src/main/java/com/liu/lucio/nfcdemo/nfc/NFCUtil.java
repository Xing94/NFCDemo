...
/**
 * Created by LucioLiu on 2017/5/4.
 */
...
public class NFCUtil {
    ...
    public NFCUtil(Context mContext) {
    ...
    public String readFromTag(Intent intent) {
        ...
        NdefMessage mNdefMsg;
        try {
            mNdefMsg = (NdefMessage) rawArray[0];
        } catch (Exception e) {
            return "";
        }
        ...
        try {
            if (mNdefRecord != null) {
                ...
                return readResult.substring(3, readResult.length()).trim();
            }
    ...
    private List<String> resolveIntent(Intent intent) {
    ...
    private List<String> buildTagViews(NdefMessage[] msgs) {
        ...
        for (NdefRecord record : records) {
            payLoadList.add(new String(record.getPayload()));
        }
        return payLoadList;
    }
